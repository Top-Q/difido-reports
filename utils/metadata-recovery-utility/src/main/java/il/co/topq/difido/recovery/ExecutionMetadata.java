...
/**
 * This is a shameless clone of the the ExecutionMetadata class that is already
 * implemented in the server. We have to do it since Spring Boot changed the way
 * they are packaging the jar and the classes are no long accessible when using
 * the jar as dependency.
 * 
 * 
 * @author Itai Agmon
 *
